  ...
  return (
    <Html lang="pt-BR">
      <Tailwind>
        ...
        <Preview>Bem-vindo à plataforma que conecta você ao melhor para seu pet 🐾</Preview>
          ...
          <Container className="bg-white rounded-[8px] mx-auto p-[20px] max-w-[600px]">
            ...
            <Section className="mt-[32px]">
              ...
              <Text className="text-[16px] text-center text-gray-600 mt-[16px] mb-[32px]">
                O lugar perfeito para conectar amantes de pets e os melhores serviços
              </Text>
            </Section>
            ...
            <Section className="bg-[#F9F5FF] rounded-[8px] p-[24px] mb-[32px]">
              ...
              <Text className="text-[16px] text-gray-700 m-0 mb-[16px]">
                Estamos muito felizes em ter você na comunidade PetSpot! Sua jornada para cuidar melhor do seu pet começa agora.
              </Text>
                ...
                <Column className="pr-[12px]">
                  <Section className="bg-white rounded-[8px] p-[16px] border-l-[4px] border-[#7E57C2]">
                    ...
                    <Text className="text-[14px] text-gray-600 m-0">
                      Localize os melhores pet shops, clínicas e serviços na sua região com avaliações reais
                    </Text>
                  </Section>
                </Column>
              </Row>
              ...
              <Row className="mb-[16px]">
                <Column className="pr-[12px]">
                  <Section className="bg-white rounded-[8px] p-[16px] border-l-[4px] border-[#7E57C2]">
                    ...
                    <Text className="text-[14px] text-gray-600 m-0">
                      Marque banho, tosa, consultas e outros serviços em poucos cliques, sem complicação
                    </Text>
                  </Section>
                </Column>
              </Row>
              ...
              <Row className="mb-[16px]">
                <Column className="pr-[12px]">
                  <Section className="bg-white rounded-[8px] p-[16px] border-l-[4px] border-[#7E57C2]">
                    ...
                    <Text className="text-[14px] text-gray-600 m-0">
                      Receba descontos especiais e promoções personalizadas para as necessidades do seu pet
                    </Text>
                  </Section>
                </Column>
              </Row>
              ...
              <Row>
                <Column className="pr-[12px]">
                  <Section className="bg-white rounded-[8px] p-[16px] border-l-[4px] border-[#7E57C2]">
                    ...
                    <Text className="text-[14px] text-gray-600 m-0">
                      Compartilhe experiências, avalie serviços e conecte-se com outros tutores de pets
                    </Text>
                  </Section>
                </Column>
              </Row>
            ...
            <Section className="border-t border-gray-200 pt-[24px]">
              ...
              <Text className="text-[12px] text-center text-gray-400 m-0 mt-[8px]">
                <a href="https://petspot.com.br/unsubscribe" className="text-gray-400">
                  Cancelar inscrição
                </a>{' '}
                •{' '}
                <a href="https://petspot.com.br/privacy" className="text-gray-400">
